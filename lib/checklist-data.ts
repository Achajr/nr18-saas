...
const TEXTO_TECNICO_REPLACEMENTS: Array<[RegExp, string]> = [
  [/\bComunicacao Previa\b/g, 'Comunicação Prévia'],
  ...
  [/\bpermanencia\b/g, 'permanência'],
  [/\bprevencao\b/g, 'prevenção'],
  [/\bSao obrigatorias\b/g, 'São obrigatórias'],
  [/\bSao obrigatorios\b/g, 'São obrigatórios'],
  [/\bSao proibidas\b/g, 'São proibidas'],
  [/\bE obrigatorio\b/g, 'É obrigatório'],
  [/\bE obrigatoria\b/g, 'É obrigatória'],
  [/\bE proibido\b/g, 'É proibido'],
  [/\bE proibida\b/g, 'É proibida'],
  [/\bso e permitido\b/g, 'só é permitido'],
  [/\bsob nenhuma condicao e permitida\b/g, 'sob nenhuma condição é permitida'],
  [/\belaboracao\b/g, 'elaboração'],
  ...
  [/\barea\b/g, 'área'],
  [/\bArea\b/g, 'Área'],
  [/\bvivencia\b/g, 'vivência'],
  [/\beletrico\b/g, 'elétrico'],
  [/\beletrica\b/g, 'elétrica'],
  [/\beletricos\b/g, 'elétricos'],
  [/\beletricas\b/g, 'elétricas'],
  [/\bEletrico\b/g, 'Elétrico'],
  [/\bInstalacoes\b/g, 'Instalações'],
  [/\binstalacoes\b/g, 'instalações'],
  ...
  [/\binventario\b/g, 'inventário'],
  [/\bespecificos\b/g, 'específicos'],
  [/\bintegracao\b/g, 'integração'],
  [/\bcondicoes\b/g, 'condições'],
  [/\bminimas\b/g, 'mínimas'],
  [/\bsanitaria\b/g, 'sanitária'],
  [/\blavatorio\b/g, 'lavatório'],
  [/\bmictorio\b/g, 'mictório'],
  [/\bproporcao\b/g, 'proporção'],
  [/\bfracao\b/g, 'fração'],
  [/\bagua\b/g, 'água'],
  [/\bAgua\b/g, 'Água'],
  [/\bpotavel\b/g, 'potável'],
  [/\bnao\b/g, 'não'],
  [/\bNao\b/g, 'Não'],
  [/\bha\b/g, 'há'],
  [/\bservicos\b/g, 'serviços'],
  [/\bservico\b/g, 'serviço'],
  [/\bintemperies\b/g, 'intempéries'],
  [/\bEdificacoes\b/g, 'Edificações'],
  [/\bedificacoes\b/g, 'edificações'],
  [/\bDemolicao\b/g, 'Demolição'],
  [/\bdemolicao\b/g, 'demolição'],
  [/\bEscavacao\b/g, 'Escavação'],
  [/\bescavacao\b/g, 'escavação'],
  [/\bfundacao\b/g, 'fundação'],
  [/\bremocao\b/g, 'remoção'],
  ...
  [/\bconcretagem\b/g, 'concretagem'],
  [/\barmacao\b/g, 'armação'],
  [/\baco\b/g, 'aço'],
  [/\bAnalise\b/g, 'Análise'],
  [/\banalise\b/g, 'análise'],
  [/\bcombustiveis\b/g, 'combustíveis'],
  [/\binflamaveis\b/g, 'inflamáveis'],
  [/\bprevio\b/g, 'prévio'],
  [/\bvigilancia\b/g, 'vigilância'],
  [/\bconclusao\b/g, 'conclusão'],
  [/\bVentilacao\b/g, 'Ventilação'],
  [/\bventilacao\b/g, 'ventilação'],
  [/\bsuperficie\b/g, 'superfície'],
  [/\bsuperficies\b/g, 'superfícies'],
  [/\bgas\b/g, 'gás'],
  [/\bposicao\b/g, 'posição'],
  [/\bvalvulas\b/g, 'válvulas'],
  [/\bProibicao\b/g, 'Proibição'],
  [/\bpressao\b/g, 'pressão'],
  [/\butilizacao\b/g, 'utilização'],
  [/\bespacos\b/g, 'espaços'],
  [/\bImpermeabilizacao\b/g, 'Impermeabilização'],
  [/\bimpermeabilizacao\b/g, 'impermeabilização'],
  [/\bflexiveis\b/g, 'flexíveis'],
  [/\bhoraria\b/g, 'horária'],
  [/\bnecessaria\b/g, 'necessária'],
  [/\bnecessario\b/g, 'necessário'],
  [/\baplicavel\b/g, 'aplicável'],
  [/\binstaveis\b/g, 'instáveis'],
  [/\bclimaticas\b/g, 'climáticas'],
  [/\btransposicao\b/g, 'transposição'],
  [/\bdiferenca\b/g, 'diferença'],
  [/\bintermediario\b/g, 'intermediário'],
  [/\bobrigatorio\b/g, 'obrigatório'],
  [/\bobrigatoria\b/g, 'obrigatória'],
  [/\bmao\b/g, 'mão'],
  [/\bportateis\b/g, 'portáteis'],
  [/\bforracao\b/g, 'forração'],
  [/\bPerimetro\b/g, 'Perímetro'],
  [/\bperimetro\b/g, 'perímetro'],
  [/\bconstrucao\b/g, 'construção'],
  [/\bConstrucao\b/g, 'Construção'],
  [/\bindustria\b/g, 'indústria'],
  [/\bIndustria\b/g, 'Indústria'],
  [/\bedificios\b/g, 'edifícios'],
  [/\bcompativel\b/g, 'compatível'],
  [/\bconcluidos\b/g, 'concluídos'],
  [/\btravessao\b/g, 'travessão'],
  [/\brodape\b/g, 'rodapé'],
  [/\bvaos\b/g, 'vãos'],
  [/\bprovisorio\b/g, 'provisório'],
  ...
  [/\bmanuais de instrucao\b/g, 'manuais de instrução'],
  [/\blingua portuguesa\b/g, 'língua portuguesa'],
  [/\bunica\b/g, 'única'],
  [/\bdimensao\b/g, 'dimensão'],
  [/\bSubstancias\b/g, 'Substâncias'],
  [/\bsubstancias\b/g, 'substâncias'],
  [/\btoxicas\b/g, 'tóxicas'],
  [/\btoxicos\b/g, 'tóxicos'],
  [/\bexplosiveis\b/g, 'explosíveis'],
  [/\bIncendio\b/g, 'Incêndio'],
  [/\bincendio\b/g, 'incêndio'],
  [/\bExplosao\b/g, 'Explosão'],
  [/\bexplosao\b/g, 'explosão'],
  [/\bAmputacao\b/g, 'Amputação'],
  [/\bamputacao\b/g, 'amputação'],
...
export function corrigirTextoTecnico(value?: string | null) {
  return TEXTO_TECNICO_REPLACEMENTS.reduce(
...
const CHECKLIST_BASE: ChecklistBloco[] = [
  {
...
export const CHECKLIST: ChecklistBloco[] = CHECKLIST_BASE.map(bloco => ({
  ...bloco,
  titulo: corrigirTextoTecnico(bloco.titulo),
  itens: bloco.itens.map(item => ({
    ...item,
    t: corrigirTextoTecnico(item.t),
    perigo: corrigirTextoTecnico(item.perigo),
    nr: corrigirTextoTecnico(item.nr),
    aplicabilidade: item.aplicabilidade ? corrigirTextoTecnico(item.aplicabilidade) : item.aplicabilidade,
    criterio: item.criterio ? corrigirTextoTecnico(item.criterio) : item.criterio,
  })),
}))
